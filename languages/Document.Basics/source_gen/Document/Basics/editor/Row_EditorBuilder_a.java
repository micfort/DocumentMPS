...
/*package*/ class Row_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsHorizontal_x9dt5l_a0(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"))) {};
    ...
    try {
      ...
      int x = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"));
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (x < ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"))).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"))).getElement(x) : null), MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"));
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"))).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, MetaAdapterFactory.getContainmentLink(0x968b09380d4f4b45L, 0x9c47d86e2dddb74bL, 0x53b09c58d92e6637L, 0x53b09c58d92e663bL, "cells"), editorContext);
